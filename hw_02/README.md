...
Formally, a distribution can be defined as a normalized measure, and the distribution of a random variable x is the measure P_x on S^' defined by setting <img src="https://mathworld.wolfram.com/images/equations/StatisticalDistribution/NumberedEquation1.svg" width=20% height=20%>
